...
export default function AskIan({
  ...
  const send = useCallback(async (text: string) => {
    ...
    try {
      ...
      pushMessage({ role: 'assistant', content: "I'm offline right now. Call us at (949) 734-0201!", timestamp: Date.now() });
    } finally {
      setLoading(false);
    }
            ...
            {messages.length === 0 ? (
                ...
                <div className="w-full max-w-3xl px-4 sm:px-8 space-y-6 sm:space-y-8">
                  ...
                  <form onSubmit={(e) => { e.preventDefault(); send(input); }} className="relative group">
                    <div className="relative">
                      ...
                      <div className="absolute -inset-1 bg-gradient-to-r from-[#FFB375] via-[#FFD7B5] to-[#EE432C] rounded-xl blur-sm opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
                      <input
                        ref={inputRef}
                        value={input}
                    ...
                    <button
                      ...
                      className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-[#FFB375]/20 rounded-lg flex items-center justify-center hover:bg-[#FFB375]/30 disabled:opacity-30 transition-colors"
                    >
              ...
              <div className="flex-1 flex flex-col max-w-4xl w-full mx-auto px-2 sm:px-4 pointer-events-auto">
                ...
                <form onSubmit={(e) => { e.preventDefault(); send(input); }} className="pb-2 group">
                  <div className="relative">
                    {/* Hardys brand gradient glow */}
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-[#FFB375] via-[#FFD7B5] to-[#EE432C] rounded-lg blur-sm opacity-60 group-hover:opacity-90 transition duration-1000 group-hover:duration-200"></div>
                    <input
                      ref={inputRef}
                      value={input}
                      onChange={(e) => setInput(e.target.value)}
                    ...
                    <button
                      type="submit"
                      disabled={!input.trim() || loading}
                      className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-[#FFB375]/20 hover:bg-[#FFB375]/30 rounded-md flex items-center justify-center disabled:opacity-30 transition-colors"
                    >
                      <Send className="w-4 h-4 text-white" />
                    </button>
                  </div>
                ...
                <div className="py-6 sm:py-8 space-y-4 sm:space-y-6 px-2 sm:px-0">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 justify-center">
                      ...
                      onClick={() => {
                        ...
                        setTimeout(() => {
                          ...
                          if (form) {
                            ...
                            // Navigate to booking page if form not found
                    ...
                    <button 
                      onClick={() => window.open('tel:+19497340201', '_self')}
                    ...
                    <button 
                      onClick={() => {
                        setInput("Can I see some recent detailing work and before/after photos?");
                        send("Can I see some recent detailing work and before/after photos?");
                      }}
