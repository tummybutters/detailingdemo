...
export default function ElkGroveCarDetailing() {
  return (
    <>
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "AutoWash",
            "name": "Hardys Wash N' Wax - Elk Grove",
            "image": "https://hardyswashnwax.com/logo.png",
            "description": "Premium mobile car detailing service that comes to your location in Elk Grove, CA and surrounding neighborhoods.",
            "address": {
              "@type": "PostalAddress",
            ...
            "url": "https://hardyswashnwax.com/elk-grove-car-detailing",
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-start gap-12">
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold mb-6">Serving All of Elk Grove, CA</h2>
              <p className="text-lg mb-6">
                Our mobile detailing service comes directly to your location throughout Elk Grove and surrounding areas.
              ...
              <div className="mb-8 bg-white p-6 rounded-lg shadow-md border-2 border-black">
                ...
                <ul className="grid grid-cols-2 gap-2">
                  ...
                  <li className="flex items-center"><MapPin className="h-5 w-5 text-[#EE432C] mr-2" /> Vintage Park</li>
                  <li className="flex items-center"><MapPin className="h-5 w-5 text-[#EE432C] mr-2" /> East Franklin</li>
                  <li className="flex items-center"><MapPin className="h-5 w-5 text-[#EE432C] mr-2" /> Sheldon</li>
                  <li className="flex items-center"><MapPin className="h-5 w-5 text-[#EE432C] mr-2" /> Lakeside</li>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <span className="text-gray-600">We come to your home, apartment, or workplace in Elk Grove</span>
                  </div>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-[#EE432C] mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <span className="font-medium block">Professional-Grade Products</span>
                    <span className="text-gray-600">We use only the highest quality detailing products</span>
                  </div>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-6 w-6 text-[#EE432C] mr-3 mt-1 flex-shrink-0" />
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-md border-2 border-black">
              ...
              <p className="text-gray-700">
                ...
                Laguna, Vintage Park, East Franklin, and all residential neighborhoods. We also serve 
                nearby areas like Sacramento and Galt.
              </p>
            </div>
